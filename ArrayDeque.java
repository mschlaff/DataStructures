...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            throw new IllegalArgumentException("Data is null. Can't add first.");
        }
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty. Can't remove first.");
        }
    ...
    public T removeLast() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty. Can't remove last.");
        }
    ...
    public T getFirst() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty. Can't get first.");
        }
    ...
    public T getLast() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("Deque is empty. Can't get last.");
        }
